...
describe("pay", () => {
  ...
  const MERCHANT_ADDR = new PublicKey("F8YNRBsQrcSFyvdQShAipH36wC1PyzSa3bsE8yC4wiZw");
  const TREASURY_ADDR = new PublicKey("BuGv6UGsmPAEHUuFz2mJoUaEjtPMqRyYowMDh8J5sX4S");
  ...
  it("Is swapped!", async () => {
    ...
    const swapIx = await program.methods.completePayment({
      orderId: new BN(9),
